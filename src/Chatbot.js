...
class Chatbot extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      messages: [
        {
          sender: "bot",
          message: "Welcome to StarTrek Bot! I answer questions based on the dataset of all StarTrek movies and TV show scripts. Here are a few things you can ask me:"
        },
        {
          sender: "bot",
  ...
  sendMessage = async (userMessage) => {
    ...
    // Make a POST request to the OpenAI GPT API
